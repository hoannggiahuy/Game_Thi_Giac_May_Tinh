...
- Boss Đông Hán.
- V7: sửa nhận diện tay, giảm nhịp độ trận, cân bằng spawn lính ta bằng hàng chờ quân.
...
class MelinhGame:
    def __init__(self):
        ...
        pygame.display.set_caption("Tiếng Trống Mê Linh - Pygame Full")
    ...
    def reconnect_camera(self) -> None:
        ...
        try:
            ...
            pass
        self.hand_tracker = HandGestureTracker()
        self.hand_state = HandState(message="Đã thử mở lại camera")
